...
// Customer delivery request (Customer only)
router.post('/request', auth, role('Customer'), deliveryCtrl.createRequest);
...
// Assign an existing delivery (Admin only)
router.put('/:id/assign', auth, role('Admin'), deliveryCtrl.assignDelivery);
